...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_UI_Interaction p_UI_Interaction;
        ...
        public static SteamVR_Input_ActionSet_UI_Interaction UI_Interaction
        {
            get
            {
                return SteamVR_Actions.p_UI_Interaction.GetCopy<SteamVR_Input_ActionSet_UI_Interaction>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_UI_Interaction = ((SteamVR_Input_ActionSet_UI_Interaction)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_UI_Interaction>("/actions/UI_Interaction")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.UI_Interaction};
        }
    }
}
